...
This directory contains all infrastructure, deployment, and operations documentation for saas202514.
...
- Add secrets to: `https://github.com/YOUR_ORG/saas202514/settings/secrets/actions`
...
|-------------|---------|-----|-------------|
| **Development** | Local machine | localhost:3014 | Manual |
| **Staging** | Testing/QA | saas202514-staging.azurecontainerapps.io | On push to `develop` |
| **Production** | Live users | saas202514.azurecontainerapps.io | On release tag |
