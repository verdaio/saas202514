...
1. Go to: `https://github.com/YOUR_ORG/saas202514/settings/secrets/actions`
...
# Check: https://github.com/YOUR_ORG/saas202514/actions
```

**Staging will be live at:** `https://saas202514-staging.azurecontainerapps.io`
...
**Production will be live at:** `https://saas202514.azurecontainerapps.io`

---

## Azure Resources Created

### Resource Group: `saas202514-rg`

All resources are organized in one resource group for easy management.

### Container Registry: `saas202514acr`

**Purpose:** Stores Docker images
**SKU:** Basic (upgradeable to Standard/Premium)
**URL:** `saas202514acr.azurecr.io`

### Container Apps Environment: `saas202514-env`
...
1. **saas202514-staging** (staging environment)
   - URL: `https://saas202514-staging.azurecontainerapps.io`
   - Min replicas: 1, Max replicas: 3
   - Auto-deploys on push to `develop` branch

2. **saas202514-prod** (production environment)
   - URL: `https://saas202514.azurecontainerapps.io`
   - Min replicas: 2, Max replicas: 10
   - Deploys on release tags only

### PostgreSQL Flexible Server: `saas202514-db`
...
**Databases:**
- `saas202514_staging` - Staging environment
- `saas202514_production` - Production environment

### Redis Cache: `saas202514-redis`
...
### Blob Storage: `saas202514storage`
...
az keyvault secret show \
  --vault-name saas202514-kv \
  --name DATABASE-URL-PRODUCTION \
  --query value -o tsv

# Connect with psql
psql "postgresql://username:password@saas202514-db.postgres.database.azure.com:5432/saas202514_production?sslmode=require"
```
...
2. Find your Container App: `saas202514-prod`
...
az containerapp logs show \
  --name saas202514-staging \
  --resource-group saas202514-rg \
  --follow

# Stream logs (production)
az containerapp logs show \
  --name saas202514-prod \
  --resource-group saas202514-rg \
  --follow
```
...
az monitor metrics alert create \
  ...
  --resource-group saas202514-rg \
  --scopes /subscriptions/{sub-id}/resourceGroups/saas202514-rg/providers/Microsoft.App/containerApps/saas202514-prod \
...
```
https://github.com/YOUR_ORG/saas202514/actions
```
...
az monitor metrics list \
  --resource /subscriptions/{sub-id}/resourceGroups/saas202514-rg/providers/Microsoft.App/containerApps/saas202514-prod \
...
az postgres flexible-server restore \
  --resource-group saas202514-rg \
  --name saas202514-db-restored \
  --source-server saas202514-db \
...
az containerapp revision activate \
  --name saas202514-prod \
  --resource-group saas202514-rg \
  --revision saas202514-prod--previous-revision
```
...
- **Project Repository**: https://github.com/ChrisStephens1971/saas202514
