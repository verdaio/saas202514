...
| **URL** | localhost:3014 | staging.azurecontainerapps.io | azurecontainerapps.io |
...
DEBUG=true
DATABASE_URL=postgresql://localhost:5414/saas202514
REDIS_URL=redis://localhost:6414
FRONTEND_URL=http://localhost:3014
CORS_ORIGINS=http://localhost:3014
```
...
NODE_ENV=staging
DEBUG=true
DATABASE_URL=postgresql://saas202514-db.postgres.database.azure.com/saas202514_staging
REDIS_URL=rediss://saas202514-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202514-staging.azurecontainerapps.io
CORS_ORIGINS=https://saas202514-staging.azurecontainerapps.io
```
...
NODE_ENV=production
DEBUG=false
DATABASE_URL=postgresql://saas202514-db.postgres.database.azure.com/saas202514_production
REDIS_URL=rediss://saas202514-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202514.azurecontainerapps.io
CORS_ORIGINS=https://saas202514.azurecontainerapps.io,https://yourdomain.com
```
...
STAGING_URL=https://saas202514-staging.azurecontainerapps.io npm run test:e2e
```
